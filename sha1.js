...
class Sha1 {
     ...
     *   'bin' - binary string ('abc' = '101010111100').
     * @returns {string} Hash of msg as hex character string.
     */
    static hash(msg, options) {
        const defaults = { msgFormat: 'string', outFormat: 'bin' };
        ...
        return (opt.outFormat=='bin') ? hexencodedToBin(H.join(separator)) : H.join(separator);
        ...
        function hexencodedToBin(hexencoded){

          var res = '';
          for(var i=0;i<hexencoded.length;i++)
            res += ('0000'+parseInt(hexencoded[i],16).toString(2)).slice(-4);
          return res;
        }
